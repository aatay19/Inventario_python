...
def exportar_pedido_unico_pdf(request, pedido_id):
    ...
    pdf.cell(40, 10, " U. x Emp.", 1, 0, "C", True)
    pdf.cell(40, 10, " Empaques", 1, 1, "C", True)
    pdf.set_text_color(0, 0, 0)
    pdf.set_font("Helvetica", "", 10)
    for det in pedido.detalles.all():
        pdf.cell(80, 10, f" {det.producto.nombre_producto[:30]}", 1, 0, "L")
        pdf.set_font("Helvetica", "", 10)
        pdf.cell(30, 10, str(det.unidad_empaque), 1, 0, "C")
        pdf.cell(40, 10, str(det.cantidad_por_empaque), 1, 0, "C")
        pdf.set_font("Helvetica", "B", 10)
        pdf.cell(40, 10, str(det.cantidad_empaques), 1, 1, "C")
    pdf.ln(15)
